CREATE PROCEDURE UpdateProfessionalPersonalCar @name VARCHAR(32), @Km DECIMAL(12,2), @RegistrationNumber VARCHAR(16),
	...
	@TrunkWidth DECIMAL(12,2), @TrunkDepth DECIMAL(12,2),@hasSaftyBar BIT, @loadCapacity DECIMAL(12,2), @vehicleID INT
	as 
	UPDATE [dbo].[Vehicle]
		SET [Name] = @name
			,[Km] = @Km
		...
		UPDATE [dbo].[ProfessionalPersonalCar]
