CREATE PROCEDURE UpdateTruck @name VARCHAR(32), @Km DECIMAL(12,2), @RegistrationNumber VARCHAR(16),
	...
	@Weight DECIMAL(12,2), @Length DECIMAL(12,2), @loadCapacity DECIMAL(12,2), @vehicleID INT
	as
	UPDATE [dbo].[Vehicle]
		SET [Name] = @name
			,[Km] = @Km
		...
		WHERE Truck.HeavyVehicleID = @heavyVehicleID
GO
