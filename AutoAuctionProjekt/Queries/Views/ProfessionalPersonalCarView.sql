CREATE VIEW ProfessionalPersonalCarView as select ProfessionalPersonalCar.ID, Vehicle.ID as VehicleID, vehicle.Name, Vehicle.Km, Vehicle.RegistrationNumber, Vehicle.Year, Vehicle.NewPrice, Vehicle.HasTowBar,
