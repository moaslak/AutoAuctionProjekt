CREATE VIEW PrivatePersonalCarView as select PrivatePersonalCar.ID, vehicle.Name, Vehicle.Km, Vehicle.RegistrationNumber, Vehicle.Year, Vehicle.NewPrice, Vehicle.HasTowBar,
