CREATE VIEW TruckView as select Truck.ID, Vehicle.ID as VehicleID, Vehicle.Name, Vehicle.Km, Vehicle.RegistrationNumber, Vehicle.NewPrice, Vehicle.Year, Vehicle.HasTowBar, Vehicle.EngineSize, Vehicle.KmPrLiter, 
