CREATE VIEW TruckView as select Truck.ID, Vehicle.Name, Vehicle.Km, Vehicle.RegistrationNumber, Vehicle.NewPrice, Vehicle.Year, Vehicle.HasTowBar, Vehicle.EngineSize, Vehicle.KmPrLiter, 
